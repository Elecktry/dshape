              ...
              @endif
                @csrf
                  ...
                  <div class="form-floating mb-3">
                    <input name="date" class="form-control" id="dataMed" type="date" value="{{$measurement->date ?? null}}"  placeholder="Data da Medição" data-sb-validations="required" />
                  ...
                  {{-- Peso --}}
                  <div class="form-floating mb-3">
                    <input name="weight" class="form-control" id="pesoKg" type="text" value="{{$measurement->weight ?? null}}"  placeholder="Peso(Kg)" data-sb-validations="required" />
                  ...
                  {{-- Altura --}}
                  <div class="form-floating mb-3">
                    <input name="height" class="form-control" id="alturaCm" type="text" value="{{$measurement->height ?? null}}" placeholder="Altura(cm)" data-sb-validations="required" />
                  ...
                  {{-- Peitoral --}}
                  <div class="form-floating mb-3">
                    <input name="chest" class="form-control" id="peitoralCm" type="text" value="{{$measurement->chest ?? null}}" placeholder="Peitoral(cm)" data-sb-validations="required" />
                  ...
                  {{-- Braço esquerdo --}}
                  <div class="form-floating mb-3">
                    <input name="left_arm" class="form-control" id="bracoEsquerdoCm" type="text" value="{{$measurement->left_arm ?? null}}" placeholder="Braço esquerdo(cm)" data-sb-validations="required" />
                  ...
                  {{-- Braço direito --}}
                  <div class="form-floating mb-3">
                    <input name="right_arm" class="form-control" id="bracoDireitoCm" type="text" value="{{$measurement->right_arm ?? null}}" placeholder="Braço direito(cm)" data-sb-validations="required" />
                  ...
                  {{-- Abdômen --}}
                  <div class="form-floating mb-3">
                    <input name="abdomen" class="form-control" id="abdomenCm" type="text" value="{{$measurement->abdomen ?? null}}" placeholder="Abdômen(cm)" data-sb-validations="required" />
                  ...
                  {{-- Cintura --}}
                  <div class="form-floating mb-3">
                    <input name="waist" class="form-control" id="cinturaCm" type="text" value="{{$measurement->waist ?? null}}" placeholder="Cintura(cm)" data-sb-validations="required" />
                  ...
                  {{-- Quadril --}}
                  <div class="form-floating mb-3">
                    <input name="hips" class="form-control" id="quadrilCm" type="text" value="{{$measurement->hips ?? null}}" placeholder="Quadril(cm)" data-sb-validations="required" />
                  ...
                  {{-- Coxa esquerda --}}
                  <div class="form-floating mb-3">
                    <input name="left_thigh" class="form-control" id="coxaEsquerdaCm" type="text" value="{{$measurement->left_thigh ?? null}}" placeholder="Coxa esquerda(cm)" data-sb-validations="required" />
                  ...
                  {{-- Coxa direita --}}
                  <div class="form-floating mb-3">
                    <input name="right_thigh" class="form-control" id="coxaDireitaCm" type="text" value="{{$measurement->right_thigh ?? null}}" placeholder="Coxa direita(cm)" data-sb-validations="required" />
                  ...
                  <div class="form-floating mb-3">
                    <input name="left_calf" class="form-control" id="panturrilhaEsquertaCm" type="text" value="{{$measurement->left_calf ?? null}}" placeholder="Panturrilha esquerta(cm)" data-sb-validations="required" />
                  ...
                  {{-- Panturrilha direita --}}
                  <div class="form-floating mb-3">
                    <input name="right_calf" class="form-control" id="panturrilhaDireitaCm" type="text" value="{{$measurement->right_calf ?? null}}" placeholder="Panturrilha direita(cm)" data-sb-validations="required" />
